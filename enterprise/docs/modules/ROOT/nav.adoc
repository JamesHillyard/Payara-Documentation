...
***** xref:Technical Documentation/Payara Server Documentation/Logging and Monitoring/Notification Service/Notifiers/MS Teams Notifier.adoc[MS Teams Notifier]
...
**** xref:Technical Documentation/Ecosystem/IDE Integration/VSCode Extension/Jakarta EE10 Transformation.adoc[Jakarta EE10 Transformation]
